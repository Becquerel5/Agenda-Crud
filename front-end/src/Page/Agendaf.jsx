...
require('moment/locale/fr.js');
    var colors= {
      ...
      "color-6":"rgba(53, 13, 12, 1)",
      "color-7":" rgba(255, 0, 0, 0.8)"
...
export default class Agendaf extends Component {
  constructor(props){
  super(props);
